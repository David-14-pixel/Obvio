...
@GetMapping("/formulariocliente/{idusuario}")
public String formulariocliente(@PathVariable(value="idusuario") Long idusuario, Model model) {
...
@PostMapping("/guardarclienteusuario")
public String guardarclienreusuario(Model model, Clientes clientes) {
	clienteservice.GuardarCliente(clientes);
	return "redirect:/";
}
}
